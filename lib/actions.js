...
export const SERVER_ADD_FAFOURITE_SONG_SUCCESS =
  'SERVER:ADD_FAFOURITE_SONG_SUCCESS';
// response payload: { }

export const SERVER_ADD_FAFOURITE_SONG_FAILURE =
  'SERVER:ADD_FAFOURITE_SONG_FAILURE';
// response payload: { message }

export const SERVER_REMOVE_FAFOURITE_SONG_SUCCESS =
  'SERVER:REMOVE_FAFOURITE_SONG_SUCCESS';
// response payload: { }

export const SERVER_REMOVE_FAFOURITE_SONG_FAILURE =
  'SERVER:REMOVE_FAFOURITE_SONG_FAILURE';
// response payload: { message }

export const SERVER_GET_FAFOURITE_SONG_SUCCESS =
  'SERVER:GET_FAFOURITE_SONG_SUCCESS';
// response payload: [ { song_id, url, title, thumbnail, duration, creator, created_date } ]

export const SERVER_GET_FAFOURITE_SONG_FAILURE =
  'SERVER:GET_FAFOURITE_SONG_FAILURE';
// response payload: { message }
...
// request payload { userId, station_id, songUrl }
...
export const CLIENT_ADD_FAVOURITE_SONG = 'CLIENT:ADD_FAVOURITE_SONG';
// request payload { songId, userId, stationId, songUrl }

export const CLIENT_REMOVE_FAVOURITE_SONG = 'CLIENT:REMOVE_FAVOURITE_SONG';
// request payload { songId, userId, stationId, songUrl }

export const CLIENT_GET_FAVOURITE_SONG = 'CLIENT:GET_FAVOURITE_SONG';
// request payload { userId }
