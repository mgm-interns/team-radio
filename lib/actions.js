...
export const CLIENT_ADD_STATION_SUCCESS = 'SERVER:ADD_STATION_CHAT_SUCCESS';
// response payload: {}

export const CLIENT_ADD_STATION_FAILURE = 'SERVER:ADD_STATION_CHAT_SUCCESS';
// // response payload: { message }
...
// response payload [{user_id, points}]
...
export const SERVER_UPDATE_STATION_CHAT = 'SERVER:UPDATE_STATION_CHAT';
// response payload: [array of chat in station]
// execute when user joins the station

export const SERVER_CHANGE_STATION_CHAT = 'SERVER:CHANGE_STATION_CHAT';
// response payload: [array of new chat in station]
// execute when station has new chat message
...
export const CLIENT_ADD_STATION_CHAT = 'CLIENT:ADD_STATION_CHAT';
// response payload: { userId, stationId, message }

export const CLIENT_LOAD_STATION_PAGING = 'CLIENT:LOAD_STATION_PAGING';

export const CLIENT_SEND_USERID = 'CLIENT:SEND_USERID';
