...
export const SERVER_SKIP_SONG_SUCCESS = 'SERVER:SKIP_SONG_SUCCESS';
// request payload { }

export const SERVER_SKIP_SONG_FAILURE = 'SERVER:SKIP_SONG_FAILURE';
// request payload { message }
